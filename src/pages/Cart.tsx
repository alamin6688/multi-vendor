        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            {cartItems.length === 0 ? (
              ...
              cartItems.map((item) => (
                <Card key={item.id} className="bg-white/70 border-blue-100 backdrop-blur-lg">
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-slate-600">by {item.vendor}</p>
          ...
          {cartItems.length > 0 && (
            <div className="space-y-6">
              ...
              <Card className="bg-white/70 border-blue-100 backdrop-blur-lg">
                <CardContent className="p-6">
                  <h3 className="font-semibold text-slate-900 mb-3">Order Benefits</h3>
                  <div className="space-y-2">
                    <div className="flex items-center text-sm text-slate-600">
                      <Badge className="mr-2 bg-green-100 text-green-800">✓</Badge>
